...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    public void createAdminUser(NewAdminBO newAdminBO) {
        ...
        // 如果人脸上传以后，择优faceId，需要和admin信息关联存储入库
    ...
    private PageGridResult setterPageGrid(List<?> adminUserList, Integer page) {
        ...
        PageGridResult griResult = new PageGridResult();
        griResult.setRows(adminUserList);
        griResult.setPage(page);
        griResult.setRecords(pageList.getPages());
        griResult.setTotal(pageList.getTotal());
        return griResult;
    }
}
